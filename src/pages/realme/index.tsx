	...
	useEffect(() => {
		const asyncFetchDailyData = async () => {
			...
			const appleCategory = allCategories.find(
				(category: any) => category.name === 'Realme'
			);
			...
			<div className="container max-w-[1200px] justify-center text-center align-middle mx-auto">
				<Slider {...settings}>
					...
					<div>
						<Image
							alt="Banner"
							src="/images/slider/slider_realme2.jpg"
							width={1200}
							height={300}
						/>
					</div>
					<div>
						<Image
							alt="Banner"
							src="/images/slider/slider_realme_3.webp"
							width={1200}
							height={300}
						/>
					</div>
