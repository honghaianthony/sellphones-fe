	...
	useEffect(() => {
		const asyncFetchDailyData = async () => {
			...
			const appleCategory = allCategories.find(
				(category: any) => category.name === 'Oppo'
			);
			...
			<div className="container max-w-[1200px] justify-center text-center align-middle mx-auto">
				<Slider {...settings}>
					...
					<div>
						<Image
							alt="Banner"
							src="/images/slider/slider_oppo2.webp"
							width={1200}
							height={300}
						/>
					</div>
					<div>
						<Image
							alt="Banner"
							src="/images/slider/slider_oppo3.webp"
							width={1200}
							height={300}
						/>
					</div>
					<div>
						<Image
							alt="Banner"
							src="/images/slider/slider_oppo4.webp"
							width={1200}
							height={300}
						/>
					</div>
